"""zabbix_sync main when host missing in Zabbix still processes others."""
...
def test_main_missing_host_in_zabbix(monkeypatch, zabbix_env, netbox_env, tmp_path, capsys):
